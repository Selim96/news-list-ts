        ...
        <div className={s.overlay} onClick={closeModalByClick}>
            <div className={s.modal}>
                ...
                <ul className={s.contacts}>
                    <li className={s.contacts_item}><a href="mailto:selim.fazylov1@gmail.com">selim.fazylov1@gmail.com</a></li>
                    <li className={s.contacts_item}><a href="tel:+380939090496">+380939090496</a></li>
